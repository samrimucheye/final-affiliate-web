...
const blogCategories = [
  {
    id: 'electronics',
    name: 'Electronics',
    description: 'Explore the latest in electronic gadgets, reviews, and buying guides.',
  ...
  },
  {
    id: 'home-goods',
    name: 'Home & Lifestyle',
    description: 'Discover essential and stylish items for your home, plus lifestyle tips.',
    imageUrl: 'https://placehold.co/600x400.png',
    aiHint: 'home decor',
  },
  {
    id: 'books',
    name: 'Books & Reading',
    description: 'Find your next great read with our book reviews and recommendations.',
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    id: 'fashion',
    name: 'Fashion & Style',
    description: 'Stay trendy with our curated selection of clothing, accessories, and style guides.',
    imageUrl: 'https://placehold.co/600x400.png',
...
const blogPosts = [
  ...
  },
  {
    ...
    shortDescription: 'Get ready for summer with the latest fashion trends, from vibrant colors to sustainable choices.',
    imageUrl: 'https://placehold.co/600x400.png',
    ...
    <div className="container mx-auto p-4 sm:p-6 lg:p-8">
      <section className="mb-12 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          ...
          across different categories to enhance your affiliate marketing journey.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {blogCategories.map(category => (
            <Card key={category.id} className="overflow-hidden hover:shadow-xl transition-shadow duration-300 ease-in-out group">
              ...
              <CardHeader className="p-4">
                <CardTitle className="text-xl font-semibold group-hover:text-primary transition-colors">{category.name}</CardTitle>
                <CardDescription className="text-sm h-16 overflow-hidden text-ellipsis">{category.description}</CardDescription>
              </CardHeader>
            ...
            <Card key={post.id} className="overflow-hidden hover:shadow-xl transition-shadow duration-300 ease-in-out group flex flex-col">
              ...
              <CardHeader className="p-4">
                <div className="flex items-center text-xs text-muted-foreground mb-2 space-x-2">
                  ...
                  <span>{blogCategories.find(c => c.id === post.categoryId)?.name || 'General'}</span>
