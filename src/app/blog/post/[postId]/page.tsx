...
import { ArrowLeft, ExternalLink, CalendarDays, UserCircle, Tag } from 'lucide-react';
...
const blogPosts = [
  ...
  },
  {
    ...
    content: 'Embark on literary adventures with our curated list of must-read novels for the year. This selection spans genres from gripping thrillers and heartwarming contemporary fiction to thought-provoking science fiction and immersive historical sagas. We highlight critically acclaimed bestsellers and hidden gems alike, offering a diverse range of stories to lose yourself in. Discover new authors and revisit beloved storytellers. Each recommendation comes with a brief synopsis to pique your interest, ensuring your next favorite book is just a page turn away. Perfect for book clubs or solo reading sessions! Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
    imageUrl: 'https://placehold.co/800x450.png',
...
const PostPage: React.FC = () => {
  ...
  const category = post ? blogCategories.find(c => c.id === post.categoryId) : null;
    ...
    return (
      <div className="container mx-auto p-4 sm:p-6 lg:p-8 text-center">
        <Card className="max-w-md mx-auto">
          ...
          <CardContent>
            <p className="text-muted-foreground mb-4">The blog post you are looking for does not exist or may have been moved.</p>
      ...
      <Card className="overflow-hidden shadow-lg">
        ...
        <CardHeader className="p-6">
          <div className="flex flex-wrap items-center text-sm text-muted-foreground mb-3 gap-x-4 gap-y-1">
            {category && (
              <Link href={`/blog/category/${category.id}`} className="hover:text-primary flex items-center">
