    ...
    <footer className="bg-muted/50 border-t mt-12 py-8 text-muted-foreground">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-3">AffiliateLink Hub</h3>
            <p className="text-sm">
              Your central place to manage and promote affiliate links efficiently.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="mailto:samrimucheye@gmail.com" aria-label="Email" className="hover:text-primary">
        ...
        <div className="border-t pt-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} AffiliateLink Hub. All rights reserved.</p>
          <p className="mt-1">
            Built with <a href="https://nextjs.org" target="_blank" rel="noopener noreferrer" className="hover:text-primary underline">Next.js</a> and <a href="https://firebase.google.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary underline">Firebase</a>.
          </p>
        </div>
      </div>
    </footer>
